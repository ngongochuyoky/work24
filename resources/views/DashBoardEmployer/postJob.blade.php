...
<main>
	<style>
	 ...
	 <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Đăng tin tuyển dụng mới</li>
            </ol>
        </nav>
	<section class="form_info">
            <div class="container">
                ...
                <form action="{{route('handPostJob')}}" method="post">
                	<div class="row">
                		<div class="col-md-8">
                            <div class="row">
                            	<div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <textarea name="description"  rows="10" placeholder="Mô tả công việc." required></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <span class="required">*</span>
                                    ...
                                    <div class="form-group">
                                        <textarea name="welfare"  rows="10" placeholder="Mô tả quyền lợi." required></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                 ...
                                 <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <textarea name="requirements_other"  rows="10" placeholder="Yêu cầu công việc." required></textarea>
                                    </div>
                                </div>
                                 <div class="col-md-12">
			                    	...
			                    	@foreach($employer as $value)
		                            	...
		                            	<div class="col-md-6">
		                            		<div class="form-group">
				                                ...
				                                required 
                                                value="
                                        <?php if($value['email_employer'] === 'undefined') {echo '';}else {echo $value['email_employer'];} ?>
                                                ">
		                            	...
		                            	<div class="col-md-6">
		                            		<div class="form-group">
				                                ...
				                                required 
				                               value="<?php if($value['tel_employer'] === 'undefined') {echo '';}else {echo $value['tel_employer'];} ?>"
				                                >
