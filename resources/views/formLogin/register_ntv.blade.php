		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 box-img">
					<h1><strong>Người Tìm Việc</strong> </h1>
					<p>Form đăng ký dành cho người tim việc</p>
				</div>
				<div class="col-lg-6 formRight">
					<form action="{{url('register_ntv')}}" method="post">
						<div class="form-group">
						    <label for="name"><i class="fa fa-user"></i>	<strong>Họ Và Tên</strong></label>
					  ...
					  <div class="form-row">
					    ...
					    <div class="form-group col-md-6">
					      ...
					      <input type="password" name="againpass" class="form-control" id="confirm_pass" />
